...
NFT_ITEM_TYPES = [
    ...
    {"name": "Club", "typeclass": _CLUB_TC, "prototype_key": "club", "description": "A heavy wooden club. Simple, brutal, and effective.", "tracking_token": "PClub"},
    {"name": "Iron Longsword", "typeclass": _LONGSWORD_TC, "prototype_key": "iron_longsword", "description": "A sturdy iron blade, forged by a competent smith.", "tracking_token": "PIronLSword"},
    {"name": "Iron Dagger", "typeclass": _DAGGER_TC, "prototype_key": "iron_dagger", "description": "A sharp iron dagger. Small but deadly in skilled hands.", "tracking_token": "PIronDagger"},
    {"name": "Iron Shortsword", "typeclass": _SHORTSWORD_TC, "prototype_key": "iron_shortsword", "description": "A well-forged iron shortsword. Quick and versatile.", "tracking_token": "PIronSSword"},
    {"name": "Spear", "typeclass": _SPEAR_TC, "prototype_key": "spear", "description": "An iron-tipped spear mounted on a wooden shaft.", "tracking_token": "PSpear"},
    {"name": "Iron Hand Axe", "typeclass": _AXE_TC, "prototype_key": "iron_hand_axe", "description": "A compact iron axe. Good for chopping more than just wood.", "tracking_token": "PIronAxe"},
    ...
    {"name": "Bronze Hand Axe", "typeclass": _AXE_TC, "prototype_key": "bronze_hand_axe", "description": "A compact bronze axe head mounted on a wooden haft.", "tracking_token": "PBronzeAxe"},
    ...
    {"name": "Iron Mace", "typeclass": _MACE_TC, "prototype_key": "iron_mace", "description": "A heavy iron mace head fixed to a wooden haft. Crushes armour with brutal efficiency.", "tracking_token": "PIronMace"},
    {"name": "Iron Hammer", "typeclass": _HAMMER_TC, "prototype_key": "iron_hammer", "description": "A solid iron hammer head mounted on a wooden haft. Delivers devastating blows.", "tracking_token": "PIronHammer"},
    ...
    {"name": "Iron Spiked Club", "typeclass": _CLUB_TC, "prototype_key": "iron_spiked_club", "description": "A heavy wooden club studded with iron spikes. Brutal and effective.", "tracking_token": "PIronSClub"},
