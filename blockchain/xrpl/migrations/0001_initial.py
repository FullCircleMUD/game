...
CURRENCY_TYPES = [
    ...
    {"currency_code": "FCMSteelIng", "resource_id": 37, "name": "Steel Ingot", "unit": "ingots", "description": "A carbon-hardened iron alloy, smelted at great heat. Used by master blacksmiths.", "weight_per_unit_kg": "1.000", "is_gold": False},
    {"currency_code": "FCMAdamanIng", "resource_id": 38, "name": "Adamantine Ingot", "unit": "ingots", "description": "A legendary star-metal ingot, harder than steel and all but indestructible. Used by grandmaster blacksmiths.", "weight_per_unit_kg": "1.000", "is_gold": False},
    {"currency_code": "FCMAdamanOre", "resource_id": 39, "name": "Adamantine Ore", "unit": "chunks", "description": "A rare star-metal ore flecked with silver-black veins. Found only in the deepest mines.", "weight_per_unit_kg": "1.500", "is_gold": False},
    {"currency_code": "FCMIronwood", "resource_id": 40, "name": "Ironwood", "unit": "logs", "description": "Rough-cut logs felled from ironwood trees. Dense, heavy, and iron-hard.", "weight_per_unit_kg": "2.500", "is_gold": False},
    {"currency_code": "FCMIronTimber", "resource_id": 41, "name": "Ironwood Timber", "unit": "planks", "description": "Sawn from ironwood at a sawmill. Used by master carpenters for high-tier weapon hafts and shafts.", "weight_per_unit_kg": "1.800", "is_gold": False},
    {"currency_code": "FCMWyvernHide", "resource_id": 42, "name": "Wyvern Hide", "unit": "hides", "description": "The raw, scale-lined hide of a wyvern. Far tougher than any beast hide — requires a skilled tanner to work.", "weight_per_unit_kg": "2.000", "is_gold": False},
    {"currency_code": "FCMWyvernLthr", "resource_id": 43, "name": "Wyvern Leather", "unit": "pieces", "description": "Tanned from wyvern hide. Tougher and more flexible than any beast leather, prized by master craftsmen.", "weight_per_unit_kg": "0.900", "is_gold": False},
    {"currency_code": "FCMStarbloomNect", "resource_id": 44, "name": "Starbloom Nectar", "unit": "vials", "description": "A luminous nectar distilled from starbloom flowers that grow only in high-altitude and magically charged zones. Base ingredient for expert-tier potions.", "weight_per_unit_kg": "0.100", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "FCMAnimalFat", "resource_id": 45, "name": "Animal Fat", "unit": "lumps", "description": "Rendered fat harvested from animals. Processed into oil at a tannery.", "weight_per_unit_kg": "0.500", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "FCMOil", "resource_id": 46, "name": "Oil", "unit": "flasks", "description": "Refined from animal fat at a tannery. Used to fuel lanterns.", "weight_per_unit_kg": "0.300", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "FCMCocoon", "resource_id": 47, "name": "Cocoon", "unit": "cocoons", "description": "A silken cocoon harvested whole from silk-spinning creatures.", "weight_per_unit_kg": "0.050", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "FCMSilk", "resource_id": 48, "name": "Silk", "unit": "bolts", "description": "Reeled and woven from cocoons at the loom. Prized by tailors for fine garments.", "weight_per_unit_kg": "0.100", "is_gold": False, "initial_reserve": "100000"},
    ...
    {"currency_code": "PCrossbow", "resource_id": None, "name": "PCrossbow", "unit": "tokens", "description": "Proxy token for Training Crossbow AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PLightCrossbow", "resource_id": None, "name": "PLightCrossbow", "unit": "tokens", "description": "Proxy token for Light Crossbow AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    ...
    {"currency_code": "PTrainRapier", "resource_id": None, "name": "PTrainRapier", "unit": "tokens", "description": "Proxy token for Training Rapier AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainBAxe", "resource_id": None, "name": "PTrainBAxe", "unit": "tokens", "description": "Proxy token for Training Battleaxe AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainHAxe", "resource_id": None, "name": "PTrainHAxe", "unit": "tokens", "description": "Proxy token for Training Hand Axe AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainSpear", "resource_id": None, "name": "PTrainSpear", "unit": "tokens", "description": "Proxy token for Training Spear AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainMace", "resource_id": None, "name": "PTrainMace", "unit": "tokens", "description": "Proxy token for Training Mace AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainHammer", "resource_id": None, "name": "PTrainHammer", "unit": "tokens", "description": "Proxy token for Training Hammer AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PTrainSling", "resource_id": None, "name": "PTrainSling", "unit": "tokens", "description": "Proxy token for Training Sling AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PWoodenGClub", "resource_id": None, "name": "PWoodenGClub", "unit": "tokens", "description": "Proxy token for Wooden Greatclub AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PBronzeLance", "resource_id": None, "name": "PBronzeLance", "unit": "tokens", "description": "Proxy token for Bronze Lance AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PBronzeGClub", "resource_id": None, "name": "PBronzeGClub", "unit": "tokens", "description": "Proxy token for Bronze Spiked Greatclub AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PBronzeStaff", "resource_id": None, "name": "PBronzeStaff", "unit": "tokens", "description": "Proxy token for Bronze-Tipped Staff AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    # ── Components ──
    ...
    # ── Potions (tiered proxy tokens: Watery = BASIC, Weak = SKILLED) ──
    {"currency_code": "PPotWatLifeEss", "resource_id": None, "name": "PPotWatLifeEss", "unit": "tokens", "description": "Proxy token for Watery Potion of Life's Essence AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakLifeEss", "resource_id": None, "name": "PPotWeakLifeEss", "unit": "tokens", "description": "Proxy token for Weak Potion of Life's Essence AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatZephyr", "resource_id": None, "name": "PPotWatZephyr", "unit": "tokens", "description": "Proxy token for Watery Potion of the Zephyr AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakZephyr", "resource_id": None, "name": "PPotWeakZephyr", "unit": "tokens", "description": "Proxy token for Weak Potion of the Zephyr AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatWellspr", "resource_id": None, "name": "PPotWatWellspr", "unit": "tokens", "description": "Proxy token for Watery Potion of the Wellspring AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakWellspr", "resource_id": None, "name": "PPotWeakWellspr", "unit": "tokens", "description": "Proxy token for Weak Potion of the Wellspring AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatBull", "resource_id": None, "name": "PPotWatBull", "unit": "tokens", "description": "Proxy token for Watery Potion of the Bull AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakBull", "resource_id": None, "name": "PPotWeakBull", "unit": "tokens", "description": "Proxy token for Weak Potion of the Bull AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatCatGrace", "resource_id": None, "name": "PPotWatCatGrace", "unit": "tokens", "description": "Proxy token for Watery Potion of Cat's Grace AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakCatGrace", "resource_id": None, "name": "PPotWeakCatGrace", "unit": "tokens", "description": "Proxy token for Weak Potion of Cat's Grace AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatBear", "resource_id": None, "name": "PPotWatBear", "unit": "tokens", "description": "Proxy token for Watery Potion of the Bear AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakBear", "resource_id": None, "name": "PPotWeakBear", "unit": "tokens", "description": "Proxy token for Weak Potion of the Bear AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatFoxCun", "resource_id": None, "name": "PPotWatFoxCun", "unit": "tokens", "description": "Proxy token for Watery Potion of Fox's Cunning AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakFoxCun", "resource_id": None, "name": "PPotWeakFoxCun", "unit": "tokens", "description": "Proxy token for Weak Potion of Fox's Cunning AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatOwlsIns", "resource_id": None, "name": "PPotWatOwlsIns", "unit": "tokens", "description": "Proxy token for Watery Potion of Owl's Insight AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakOwlsIns", "resource_id": None, "name": "PPotWeakOwlsIns", "unit": "tokens", "description": "Proxy token for Weak Potion of Owl's Insight AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWatSilTong", "resource_id": None, "name": "PPotWatSilTong", "unit": "tokens", "description": "Proxy token for Watery Potion of Silver Tongue AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakSilTong", "resource_id": None, "name": "PPotWeakSilTong", "unit": "tokens", "description": "Proxy token for Weak Potion of Silver Tongue AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    # ── Skilled potion proxy tokens ──
    {"currency_code": "PPotWeakInvis", "resource_id": None, "name": "PPotWeakInvis", "unit": "tokens", "description": "Proxy token for Weak Potion of Invisibility AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakDetection", "resource_id": None, "name": "PPotWeakDetection", "unit": "tokens", "description": "Proxy token for Weak Potion of Detection AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakDarkvision", "resource_id": None, "name": "PPotWeakDarkvision", "unit": "tokens", "description": "Proxy token for Weak Potion of Darkvision AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakBarkskin", "resource_id": None, "name": "PPotWeakBarkskin", "unit": "tokens", "description": "Proxy token for Weak Potion of Barkskin AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    {"currency_code": "PPotWeakFeathFall", "resource_id": None, "name": "PPotWeakFeathFall", "unit": "tokens", "description": "Proxy token for Weak Potion of Feather Fall AMM pricing.", "weight_per_unit_kg": "0.000", "is_gold": False, "initial_reserve": "100000"},
    # ── Jewellery ──
...
_GREATCLUB_TC = "typeclasses.items.weapons.greatclub_nft_item.GreatclubNFTItem"
_NINJATO_TC = "typeclasses.items.weapons.ninjato_nft_item.NinjatoNFTItem"
_NUNCHAKU_TC = "typeclasses.items.weapons.nunchaku_nft_item.NunchakuNFTItem"
_SAI_TC = "typeclasses.items.weapons.sai_nft_item.SaiNFTItem"
_SHURIKEN_TC = "typeclasses.items.weapons.shuriken_nft_item.ShurikenNFTItem"
_BLOWGUN_TC = "typeclasses.items.weapons.blowgun_nft_item.BlowgunNFTItem"
_BOLA_TC = "typeclasses.items.weapons.bola_nft_item.BolaNFTItem"
...
NFT_ITEM_TYPES = [
    ...
    # ── Weapons: Steel tier ──
    {"name": "Steel Longsword", "typeclass": _LONGSWORD_TC, "prototype_key": "steel_longsword", "description": "A finely forged steel blade with a mirror polish. Holds its edge through any fight."},
    {"name": "Steel Shortsword", "typeclass": _SHORTSWORD_TC, "prototype_key": "steel_shortsword", "description": "A finely forged steel shortsword. Fast, balanced, and keen-edged."},
    {"name": "Steel Dagger", "typeclass": _DAGGER_TC, "prototype_key": "steel_dagger", "description": "A slender steel dagger with a needle point. Deadly in practiced hands."},
    {"name": "Steel Greatsword", "typeclass": _GREATSWORD_TC, "prototype_key": "steel_greatsword", "description": "A full-length steel greatsword with a fuller running down its blade."},
    {"name": "Steel Rapier", "typeclass": _RAPIER_TC, "prototype_key": "steel_rapier", "description": "A supple steel rapier with a swept hilt. Flexes where it must, bites where it strikes."},
    {"name": "Steel Battleaxe", "typeclass": _BATTLEAXE_TC, "prototype_key": "steel_battleaxe", "description": "A broad steel axe head with a wicked crescent edge."},
    {"name": "Steel Hand Axe", "typeclass": _AXE_TC, "prototype_key": "steel_hand_axe", "description": "A compact steel axe with a keen crescent edge."},
    {"name": "Steel Spear", "typeclass": _SPEAR_TC, "prototype_key": "steel_spear", "description": "A steel-tipped spear with a leaf-shaped blade."},
    {"name": "Steel Lance", "typeclass": _LANCE_TC, "prototype_key": "steel_lance", "description": "A reinforced ash shaft tipped with a tempered steel head."},
    {"name": "Steel Mace", "typeclass": _MACE_TC, "prototype_key": "steel_mace", "description": "A flanged steel mace head fixed to a hardwood haft."},
    {"name": "Steel Hammer", "typeclass": _HAMMER_TC, "prototype_key": "steel_hammer", "description": "A heavy tempered steel hammer head on a reinforced haft."},
    # ── Weapons: Adamantine tier ──
    {"name": "Adamantine Longsword", "typeclass": _LONGSWORD_TC, "prototype_key": "adamantine_longsword", "description": "A legendary blade forged from star-metal."},
    {"name": "Adamantine Shortsword", "typeclass": _SHORTSWORD_TC, "prototype_key": "adamantine_shortsword", "description": "A lethal blade of star-metal."},
    {"name": "Adamantine Dagger", "typeclass": _DAGGER_TC, "prototype_key": "adamantine_dagger", "description": "A whisper-thin dagger of star-metal."},
    {"name": "Adamantine Greatsword", "typeclass": _GREATSWORD_TC, "prototype_key": "adamantine_greatsword", "description": "A colossal blade of star-metal that seems lighter than it ought to be."},
    {"name": "Adamantine Rapier", "typeclass": _RAPIER_TC, "prototype_key": "adamantine_rapier", "description": "A whisper-light rapier of star-metal."},
    {"name": "Adamantine Battleaxe", "typeclass": _BATTLEAXE_TC, "prototype_key": "adamantine_battleaxe", "description": "A monstrous star-metal axe."},
    {"name": "Adamantine Hand Axe", "typeclass": _AXE_TC, "prototype_key": "adamantine_hand_axe", "description": "A star-metal handaxe so keen the edge seems to cut the air before the wood."},
    {"name": "Adamantine Spear", "typeclass": _SPEAR_TC, "prototype_key": "adamantine_spear", "description": "A star-metal spearhead on a sky-iron shaft."},
    {"name": "Adamantine Lance", "typeclass": _LANCE_TC, "prototype_key": "adamantine_lance", "description": "A legendary cavalry lance of star-metal."},
    {"name": "Adamantine Mace", "typeclass": _MACE_TC, "prototype_key": "adamantine_mace", "description": "A star-metal mace with wicked flanges."},
    {"name": "Adamantine Hammer", "typeclass": _HAMMER_TC, "prototype_key": "adamantine_hammer", "description": "A star-metal warhammer that weighs far more than it ought to."},
    # ── Weapons: missing tier fills ──
    {"name": "Iron Greatsword", "typeclass": _GREATSWORD_TC, "prototype_key": "iron_greatsword", "description": "A massive two-handed iron blade. A proper battlefield weapon."},
    {"name": "Training Rapier", "typeclass": _RAPIER_TC, "prototype_key": "training_rapier", "description": "A slender wooden practice rapier with a padded tip.", "tracking_token": "PTrainRapier"},
    {"name": "Iron Rapier", "typeclass": _RAPIER_TC, "prototype_key": "iron_rapier", "description": "A slim iron thrusting blade with a basket hilt."},
    {"name": "Training Battleaxe", "typeclass": _BATTLEAXE_TC, "prototype_key": "training_battleaxe", "description": "A carved wooden practice battleaxe.", "tracking_token": "PTrainBAxe"},
    {"name": "Iron Battleaxe", "typeclass": _BATTLEAXE_TC, "prototype_key": "iron_battleaxe", "description": "A large two-handed iron axe head mounted on a reinforced wooden haft."},
    {"name": "Training Hand Axe", "typeclass": _AXE_TC, "prototype_key": "training_hand_axe", "description": "A wooden practice axe shaped like a handaxe.", "tracking_token": "PTrainHAxe"},
    {"name": "Training Spear", "typeclass": _SPEAR_TC, "prototype_key": "training_spear", "description": "A straight wooden shaft with a blunted, thickened tip.", "tracking_token": "PTrainSpear"},
    {"name": "Bronze Lance", "typeclass": _LANCE_TC, "prototype_key": "bronze_lance", "description": "A long wooden lance tipped with a bronze spearhead.", "tracking_token": "PBronzeLance"},
    {"name": "Iron Lance", "typeclass": _LANCE_TC, "prototype_key": "iron_lance", "description": "A long wooden lance tipped with a heavy iron head."},
    {"name": "Training Mace", "typeclass": _MACE_TC, "prototype_key": "training_mace", "description": "A practice mace with a rounded wooden head.", "tracking_token": "PTrainMace"},
    {"name": "Training Hammer", "typeclass": _HAMMER_TC, "prototype_key": "training_hammer", "description": "A carved wooden hammer with a heavy head.", "tracking_token": "PTrainHammer"},
    # ── Greatclub line (5 tiers) ──
    {"name": "Wooden Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "wooden_greatclub", "description": "A massive length of timber as thick as a man's thigh.", "tracking_token": "PWoodenGClub"},
    {"name": "Bronze Spiked Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "bronze_spiked_greatclub", "description": "A massive timber greatclub studded with bronze spikes.", "tracking_token": "PBronzeGClub"},
    {"name": "Iron Spiked Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "iron_spiked_greatclub", "description": "A massive timber greatclub bristling with iron spikes."},
    {"name": "Ironwood Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "ironwood_greatclub", "description": "A massive greatclub hewn from a single ironwood trunk."},
    {"name": "Steel Spiked Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "steel_spiked_greatclub", "description": "An ironwood greatclub studded with tempered steel spikes."},
    {"name": "Adamantine Spiked Greatclub", "typeclass": _GREATCLUB_TC, "prototype_key": "adamantine_spiked_greatclub", "description": "An ironwood haft driven through with star-metal spikes."},
    # ── Club line: upper tiers ──
    {"name": "Ironwood Club", "typeclass": _CLUB_TC, "prototype_key": "ironwood_club", "description": "A heavy club carved from a single length of ironwood."},
    {"name": "Steel Spiked Club", "typeclass": _CLUB_TC, "prototype_key": "steel_spiked_club", "description": "An ironwood club driven through with tempered steel spikes."},
    {"name": "Adamantine Spiked Club", "typeclass": _CLUB_TC, "prototype_key": "adamantine_spiked_club", "description": "An ironwood haft bristling with star-metal spikes."},
    # ── Ninja weapons (remort-gated, iron/steel/adamantine 3-tier) ──
    {"name": "Iron Ninjatō", "typeclass": _NINJATO_TC, "prototype_key": "iron_ninjato", "description": "A short, straight-bladed iron ninjatō."},
    {"name": "Steel Ninjatō", "typeclass": _NINJATO_TC, "prototype_key": "steel_ninjato", "description": "A folded-steel ninjatō with a sharkskin-wrapped hilt."},
    {"name": "Adamantine Ninjatō", "typeclass": _NINJATO_TC, "prototype_key": "adamantine_ninjato", "description": "A star-metal ninjatō forged in secret by a master of the shadow arts."},
    {"name": "Training Nunchaku", "typeclass": _NUNCHAKU_TC, "prototype_key": "training_nunchaku", "description": "A practice pair of hardwood batons joined by a short chain."},
    {"name": "Nunchaku", "typeclass": _NUNCHAKU_TC, "prototype_key": "nunchaku", "description": "A pair of hardwood batons joined by a short chain."},
    {"name": "Ironwood Nunchaku", "typeclass": _NUNCHAKU_TC, "prototype_key": "ironwood_nunchaku", "description": "A master-crafted pair of ironwood batons joined by a wyvern-leather cord."},
    {"name": "Master Nunchaku", "typeclass": _NUNCHAKU_TC, "prototype_key": "master_nunchaku", "description": "The finest nunchaku a grandmaster carpenter can shape."},
    {"name": "Bronze Sai", "typeclass": _SAI_TC, "prototype_key": "bronze_sai", "description": "A short bronze truncheon flanked by two prongs."},
    {"name": "Iron Sai", "typeclass": _SAI_TC, "prototype_key": "iron_sai", "description": "A short iron truncheon flanked by two prongs."},
    {"name": "Steel Sai", "typeclass": _SAI_TC, "prototype_key": "steel_sai", "description": "A tempered steel sai with a mirror-polished central tine."},
    {"name": "Adamantine Sai", "typeclass": _SAI_TC, "prototype_key": "adamantine_sai", "description": "A star-metal sai whose prongs will turn aside any blade."},
    {"name": "Bronze Shuriken", "typeclass": _SHURIKEN_TC, "prototype_key": "bronze_shuriken", "description": "A four-pointed bronze throwing star."},
    {"name": "Iron Shuriken", "typeclass": _SHURIKEN_TC, "prototype_key": "iron_shuriken", "description": "A four-pointed iron throwing star."},
    {"name": "Steel Shuriken", "typeclass": _SHURIKEN_TC, "prototype_key": "steel_shuriken", "description": "A razor-honed steel throwing star."},
    {"name": "Adamantine Shuriken", "typeclass": _SHURIKEN_TC, "prototype_key": "adamantine_shuriken", "description": "A star-metal shuriken as black as a moonless night."},
    {"name": "Blowgun", "typeclass": _BLOWGUN_TC, "prototype_key": "blowgun", "description": "A length of hollow hardwood bored smooth along its length."},
    {"name": "Bola", "typeclass": _BOLA_TC, "prototype_key": "bola", "description": "Three weighted stones lashed to leather cords."},
    # ── Bow line (5 tiers mapped to material power levels) ──
    {"name": "Horse Bow", "typeclass": _BOW_TC, "prototype_key": "horse_bow", "description": "A powerful recurved bow laminated from wood, horn, and sinew.", "tracking_token": "PHorseBow"},
    {"name": "Longbow", "typeclass": _BOW_TC, "prototype_key": "longbow", "description": "A tall stave of seasoned yew, taller than the archer who draws it."},
    {"name": "Compound Bow", "typeclass": _BOW_TC, "prototype_key": "compound_bow", "description": "A masterwork bow built with cam pulleys and sinew cables."},
    # ── Crossbow line (5 tiers) ──
    {"name": "Training Crossbow", "typeclass": _CROSSBOW_TC, "prototype_key": "training_crossbow", "description": "A simple wooden-prod practice crossbow.", "tracking_token": "PCrossbow"},
    {"name": "Light Crossbow", "typeclass": _CROSSBOW_TC, "prototype_key": "light_crossbow", "description": "A compact crossbow with a bronze prod mounted on a timber stock.", "tracking_token": "PLightCrossbow"},
    {"name": "Hunting Crossbow", "typeclass": _CROSSBOW_TC, "prototype_key": "hunting_crossbow", "description": "A well-made crossbow with an iron prod and reinforced stock."},
    {"name": "Heavy Crossbow", "typeclass": _CROSSBOW_TC, "prototype_key": "heavy_crossbow", "description": "A powerful crossbow built around a tempered steel prod."},
    {"name": "Arbalest", "typeclass": _CROSSBOW_TC, "prototype_key": "arbalest", "description": "A master-crafted crossbow with a star-metal prod and windlass spanning gear."},
    # ── Staff line (5 tiers) ──
    {"name": "Bronze-Tipped Staff", "typeclass": _STAFF_TC, "prototype_key": "bronze_tipped_staff", "description": "A sturdy timber staff capped at both ends with heavy bronze fittings.", "tracking_token": "PBronzeStaff"},
    {"name": "Iron-Tipped Staff", "typeclass": _STAFF_TC, "prototype_key": "iron_tipped_staff", "description": "A hardwood staff shod with iron bands and ferrules."},
    {"name": "Ironwood Staff", "typeclass": _STAFF_TC, "prototype_key": "ironwood_staff", "description": "A full-length staff hewn from a single ironwood limb."},
    {"name": "Steel-Tipped Staff", "typeclass": _STAFF_TC, "prototype_key": "steel_tipped_staff", "description": "A hardwood staff ringed with tempered steel bands and sharpened steel caps."},
    {"name": "Adamantine-Tipped Staff", "typeclass": _STAFF_TC, "prototype_key": "adamantine_tipped_staff", "description": "An ironwood staff capped and banded in star-metal."},
    # ── Components ──
    {"name": "Stock", "typeclass": _BASE_TC, "prototype_key": "stock", "description": "A shaped timber stock designed to hold a crossbow mechanism.", "tracking_token": "PStock"},
    ...
    {"name": "Training Sling", "typeclass": _SLING_TC, "prototype_key": "training_sling", "description": "A rough strip of cloth knotted into a crude sling.", "tracking_token": "PTrainSling"},
    {"name": "Wyvern Leather Sling", "typeclass": _SLING_TC, "prototype_key": "wyvern_leather_sling", "description": "A sling cut from supple wyvern hide."},
    {"name": "Masterwork Sling", "typeclass": _SLING_TC, "prototype_key": "masterwork_sling", "description": "A masterwork sling of double-braided wyvern leather, balanced to the gram."},
    ...
    # ── Potions (5 quality tiers per potion: Watery/Weak/Standard/Potent/Ascendant) ──
    # Each tier has its own prototype_key and effects baked into default_metadata.
    # Life's Essence (HP restore)
    {"name": "Watery Potion of Life's Essence", "typeclass": _POTION_TC, "prototype_key": "watery_lifes_essence", "description": "A glowing crimson potion that smells of bloodmoss and warmth.", "tracking_token": "PPotWatLifeEss", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "restore", "stat": "hp", "dice": "2d4+1"}], "duration": 0}},
    {"name": "Weak Potion of Life's Essence", "typeclass": _POTION_TC, "prototype_key": "weak_lifes_essence", "description": "A glowing crimson potion that smells of bloodmoss and warmth.", "tracking_token": "PPotWeakLifeEss", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "restore", "stat": "hp", "dice": "4d4+2"}], "duration": 0}},
    {"name": "Standard Potion of Life's Essence", "typeclass": _POTION_TC, "prototype_key": "standard_lifes_essence", "description": "A glowing crimson potion that smells of bloodmoss and warmth.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "restore", "stat": "hp", "dice": "6d4+3"}], "duration": 0}},
    {"name": "Potent Potion of Life's Essence", "typeclass": _POTION_TC, "prototype_key": "potent_lifes_essence", "description": "A glowing crimson potion that smells of bloodmoss and warmth.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "restore", "stat": "hp", "dice": "8d4+4"}], "duration": 0}},
    {"name": "Ascendant Potion of Life's Essence", "typeclass": _POTION_TC, "prototype_key": "ascendant_lifes_essence", "description": "A glowing crimson potion that smells of bloodmoss and warmth.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "restore", "stat": "hp", "dice": "10d4+5"}], "duration": 0}},
    # The Zephyr (move restore)
    {"name": "Watery Potion of the Zephyr", "typeclass": _POTION_TC, "prototype_key": "watery_the_zephyr", "description": "A pale blue potion that swirls like a miniature storm.", "tracking_token": "PPotWatZephyr", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "restore", "stat": "move", "dice": "2d4+1"}], "duration": 0}},
    {"name": "Weak Potion of the Zephyr", "typeclass": _POTION_TC, "prototype_key": "weak_the_zephyr", "description": "A pale blue potion that swirls like a miniature storm.", "tracking_token": "PPotWeakZephyr", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "restore", "stat": "move", "dice": "4d4+2"}], "duration": 0}},
    {"name": "Standard Potion of the Zephyr", "typeclass": _POTION_TC, "prototype_key": "standard_the_zephyr", "description": "A pale blue potion that swirls like a miniature storm.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "restore", "stat": "move", "dice": "6d4+3"}], "duration": 0}},
    {"name": "Potent Potion of the Zephyr", "typeclass": _POTION_TC, "prototype_key": "potent_the_zephyr", "description": "A pale blue potion that swirls like a miniature storm.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "restore", "stat": "move", "dice": "8d4+4"}], "duration": 0}},
    {"name": "Ascendant Potion of the Zephyr", "typeclass": _POTION_TC, "prototype_key": "ascendant_the_zephyr", "description": "A pale blue potion that swirls like a miniature storm.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "restore", "stat": "move", "dice": "10d4+5"}], "duration": 0}},
    # The Wellspring (mana restore)
    {"name": "Watery Potion of the Wellspring", "typeclass": _POTION_TC, "prototype_key": "watery_the_wellspring", "description": "A shimmering violet potion that hums with arcane resonance.", "tracking_token": "PPotWatWellspr", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "restore", "stat": "mana", "dice": "2d4+1"}], "duration": 0}},
    {"name": "Weak Potion of the Wellspring", "typeclass": _POTION_TC, "prototype_key": "weak_the_wellspring", "description": "A shimmering violet potion that hums with arcane resonance.", "tracking_token": "PPotWeakWellspr", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "restore", "stat": "mana", "dice": "4d4+2"}], "duration": 0}},
    {"name": "Standard Potion of the Wellspring", "typeclass": _POTION_TC, "prototype_key": "standard_the_wellspring", "description": "A shimmering violet potion that hums with arcane resonance.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "restore", "stat": "mana", "dice": "6d4+3"}], "duration": 0}},
    {"name": "Potent Potion of the Wellspring", "typeclass": _POTION_TC, "prototype_key": "potent_the_wellspring", "description": "A shimmering violet potion that hums with arcane resonance.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "restore", "stat": "mana", "dice": "8d4+4"}], "duration": 0}},
    {"name": "Ascendant Potion of the Wellspring", "typeclass": _POTION_TC, "prototype_key": "ascendant_the_wellspring", "description": "A shimmering violet potion that hums with arcane resonance.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "restore", "stat": "mana", "dice": "10d4+5"}], "duration": 0}},
    # The Bull (strength)
    {"name": "Watery Potion of the Bull", "typeclass": _POTION_TC, "prototype_key": "watery_the_bull", "description": "A thick, earthy potion that smells of mushrooms and raw power.", "tracking_token": "PPotWatBull", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "strength", "value": 1}], "duration": 60, "named_effect_key": "potion_strength"}},
    {"name": "Weak Potion of the Bull", "typeclass": _POTION_TC, "prototype_key": "weak_the_bull", "description": "A thick, earthy potion that smells of mushrooms and raw power.", "tracking_token": "PPotWeakBull", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "strength", "value": 2}], "duration": 120, "named_effect_key": "potion_strength"}},
    {"name": "Standard Potion of the Bull", "typeclass": _POTION_TC, "prototype_key": "standard_the_bull", "description": "A thick, earthy potion that smells of mushrooms and raw power.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "strength", "value": 3}], "duration": 180, "named_effect_key": "potion_strength"}},
    {"name": "Potent Potion of the Bull", "typeclass": _POTION_TC, "prototype_key": "potent_the_bull", "description": "A thick, earthy potion that smells of mushrooms and raw power.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "strength", "value": 4}], "duration": 240, "named_effect_key": "potion_strength"}},
    {"name": "Ascendant Potion of the Bull", "typeclass": _POTION_TC, "prototype_key": "ascendant_the_bull", "description": "A thick, earthy potion that smells of mushrooms and raw power.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "strength", "value": 5}], "duration": 300, "named_effect_key": "potion_strength"}},
    # Cat's Grace (dexterity)
    {"name": "Watery Potion of Cat's Grace", "typeclass": _POTION_TC, "prototype_key": "watery_cats_grace", "description": "A quicksilver potion that shifts and flows like liquid shadow.", "tracking_token": "PPotWatCatGrace", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "dexterity", "value": 1}], "duration": 60, "named_effect_key": "potion_dexterity"}},
    {"name": "Weak Potion of Cat's Grace", "typeclass": _POTION_TC, "prototype_key": "weak_cats_grace", "description": "A quicksilver potion that shifts and flows like liquid shadow.", "tracking_token": "PPotWeakCatGrace", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "dexterity", "value": 2}], "duration": 120, "named_effect_key": "potion_dexterity"}},
    {"name": "Standard Potion of Cat's Grace", "typeclass": _POTION_TC, "prototype_key": "standard_cats_grace", "description": "A quicksilver potion that shifts and flows like liquid shadow.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "dexterity", "value": 3}], "duration": 180, "named_effect_key": "potion_dexterity"}},
    {"name": "Potent Potion of Cat's Grace", "typeclass": _POTION_TC, "prototype_key": "potent_cats_grace", "description": "A quicksilver potion that shifts and flows like liquid shadow.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "dexterity", "value": 4}], "duration": 240, "named_effect_key": "potion_dexterity"}},
    {"name": "Ascendant Potion of Cat's Grace", "typeclass": _POTION_TC, "prototype_key": "ascendant_cats_grace", "description": "A quicksilver potion that shifts and flows like liquid shadow.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "dexterity", "value": 5}], "duration": 300, "named_effect_key": "potion_dexterity"}},
    # The Bear (constitution)
    {"name": "Watery Potion of the Bear", "typeclass": _POTION_TC, "prototype_key": "watery_the_bear", "description": "A dark amber potion with flecks of bark suspended within.", "tracking_token": "PPotWatBear", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "constitution", "value": 1}], "duration": 60, "named_effect_key": "potion_constitution"}},
    {"name": "Weak Potion of the Bear", "typeclass": _POTION_TC, "prototype_key": "weak_the_bear", "description": "A dark amber potion with flecks of bark suspended within.", "tracking_token": "PPotWeakBear", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "constitution", "value": 2}], "duration": 120, "named_effect_key": "potion_constitution"}},
    {"name": "Standard Potion of the Bear", "typeclass": _POTION_TC, "prototype_key": "standard_the_bear", "description": "A dark amber potion with flecks of bark suspended within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "constitution", "value": 3}], "duration": 180, "named_effect_key": "potion_constitution"}},
    {"name": "Potent Potion of the Bear", "typeclass": _POTION_TC, "prototype_key": "potent_the_bear", "description": "A dark amber potion with flecks of bark suspended within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "constitution", "value": 4}], "duration": 240, "named_effect_key": "potion_constitution"}},
    {"name": "Ascendant Potion of the Bear", "typeclass": _POTION_TC, "prototype_key": "ascendant_the_bear", "description": "A dark amber potion with flecks of bark suspended within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "constitution", "value": 5}], "duration": 300, "named_effect_key": "potion_constitution"}},
    # Fox's Cunning (intelligence)
    {"name": "Watery Potion of Fox's Cunning", "typeclass": _POTION_TC, "prototype_key": "watery_foxs_cunning", "description": "A luminous golden potion that seems to glow from within.", "tracking_token": "PPotWatFoxCun", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "intelligence", "value": 1}], "duration": 60, "named_effect_key": "potion_intelligence"}},
    {"name": "Weak Potion of Fox's Cunning", "typeclass": _POTION_TC, "prototype_key": "weak_foxs_cunning", "description": "A luminous golden potion that seems to glow from within.", "tracking_token": "PPotWeakFoxCun", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "intelligence", "value": 2}], "duration": 120, "named_effect_key": "potion_intelligence"}},
    {"name": "Standard Potion of Fox's Cunning", "typeclass": _POTION_TC, "prototype_key": "standard_foxs_cunning", "description": "A luminous golden potion that seems to glow from within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "intelligence", "value": 3}], "duration": 180, "named_effect_key": "potion_intelligence"}},
    {"name": "Potent Potion of Fox's Cunning", "typeclass": _POTION_TC, "prototype_key": "potent_foxs_cunning", "description": "A luminous golden potion that seems to glow from within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "intelligence", "value": 4}], "duration": 240, "named_effect_key": "potion_intelligence"}},
    {"name": "Ascendant Potion of Fox's Cunning", "typeclass": _POTION_TC, "prototype_key": "ascendant_foxs_cunning", "description": "A luminous golden potion that seems to glow from within.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "intelligence", "value": 5}], "duration": 300, "named_effect_key": "potion_intelligence"}},
    # Owl's Insight (wisdom)
    {"name": "Watery Potion of Owl's Insight", "typeclass": _POTION_TC, "prototype_key": "watery_owls_insight", "description": "A clear, sage-scented potion with a faint green tint.", "tracking_token": "PPotWatOwlsIns", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "wisdom", "value": 1}], "duration": 60, "named_effect_key": "potion_wisdom"}},
    {"name": "Weak Potion of Owl's Insight", "typeclass": _POTION_TC, "prototype_key": "weak_owls_insight", "description": "A clear, sage-scented potion with a faint green tint.", "tracking_token": "PPotWeakOwlsIns", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "wisdom", "value": 2}], "duration": 120, "named_effect_key": "potion_wisdom"}},
    {"name": "Standard Potion of Owl's Insight", "typeclass": _POTION_TC, "prototype_key": "standard_owls_insight", "description": "A clear, sage-scented potion with a faint green tint.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "wisdom", "value": 3}], "duration": 180, "named_effect_key": "potion_wisdom"}},
    {"name": "Potent Potion of Owl's Insight", "typeclass": _POTION_TC, "prototype_key": "potent_owls_insight", "description": "A clear, sage-scented potion with a faint green tint.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "wisdom", "value": 4}], "duration": 240, "named_effect_key": "potion_wisdom"}},
    {"name": "Ascendant Potion of Owl's Insight", "typeclass": _POTION_TC, "prototype_key": "ascendant_owls_insight", "description": "A clear, sage-scented potion with a faint green tint.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "wisdom", "value": 5}], "duration": 300, "named_effect_key": "potion_wisdom"}},
    # Silver Tongue (charisma)
    {"name": "Watery Potion of Silver Tongue", "typeclass": _POTION_TC, "prototype_key": "watery_silver_tongue", "description": "An iridescent potion with a sweet, intoxicating aroma.", "tracking_token": "PPotWatSilTong", "default_metadata": {"potion_mastery_tier": 1, "potion_effects": [{"type": "stat_bonus", "stat": "charisma", "value": 1}], "duration": 60, "named_effect_key": "potion_charisma"}},
    {"name": "Weak Potion of Silver Tongue", "typeclass": _POTION_TC, "prototype_key": "weak_silver_tongue", "description": "An iridescent potion with a sweet, intoxicating aroma.", "tracking_token": "PPotWeakSilTong", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "charisma", "value": 2}], "duration": 120, "named_effect_key": "potion_charisma"}},
    {"name": "Standard Potion of Silver Tongue", "typeclass": _POTION_TC, "prototype_key": "standard_silver_tongue", "description": "An iridescent potion with a sweet, intoxicating aroma.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "charisma", "value": 3}], "duration": 180, "named_effect_key": "potion_charisma"}},
    {"name": "Potent Potion of Silver Tongue", "typeclass": _POTION_TC, "prototype_key": "potent_silver_tongue", "description": "An iridescent potion with a sweet, intoxicating aroma.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "charisma", "value": 4}], "duration": 240, "named_effect_key": "potion_charisma"}},
    {"name": "Ascendant Potion of Silver Tongue", "typeclass": _POTION_TC, "prototype_key": "ascendant_silver_tongue", "description": "An iridescent potion with a sweet, intoxicating aroma.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "charisma", "value": 5}], "duration": 300, "named_effect_key": "potion_charisma"}},
    # Detection (SKILLED — detect invisible condition, exploration duration scaling)
    {"name": "Weak Potion of Detection", "typeclass": _POTION_TC, "prototype_key": "weak_detection", "description": "A shimmering potion flecked with tiny motes of light that seem to peer back at you.", "tracking_token": "PPotWeakDetection", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "condition", "condition": "detect_invis"}], "duration": 600, "named_effect_key": "detect_invis"}},
    {"name": "Standard Potion of Detection", "typeclass": _POTION_TC, "prototype_key": "standard_detection", "description": "A shimmering potion flecked with tiny motes of light that seem to peer back at you.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "detect_invis"}], "duration": 1800, "named_effect_key": "detect_invis"}},
    {"name": "Potent Potion of Detection", "typeclass": _POTION_TC, "prototype_key": "potent_detection", "description": "A shimmering potion flecked with tiny motes of light that seem to peer back at you.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "detect_invis"}], "duration": 3600, "named_effect_key": "detect_invis"}},
    {"name": "Ascendant Potion of Detection", "typeclass": _POTION_TC, "prototype_key": "ascendant_detection", "description": "A shimmering potion flecked with tiny motes of light that seem to peer back at you.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "detect_invis"}], "duration": 7200, "named_effect_key": "detect_invis"}},
    # Darkvision (SKILLED — darkvision condition, exploration duration scaling)
    {"name": "Weak Potion of Darkvision", "typeclass": _POTION_TC, "prototype_key": "weak_darkvision", "description": "An inky black potion with faint silver swirls that seem to glow in dim light.", "tracking_token": "PPotWeakDarkvision", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "condition", "condition": "darkvision"}], "duration": 600, "named_effect_key": "darkvision_buff"}},
    {"name": "Standard Potion of Darkvision", "typeclass": _POTION_TC, "prototype_key": "standard_darkvision", "description": "An inky black potion with faint silver swirls that seem to glow in dim light.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "darkvision"}], "duration": 1800, "named_effect_key": "darkvision_buff"}},
    {"name": "Potent Potion of Darkvision", "typeclass": _POTION_TC, "prototype_key": "potent_darkvision", "description": "An inky black potion with faint silver swirls that seem to glow in dim light.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "darkvision"}], "duration": 3600, "named_effect_key": "darkvision_buff"}},
    {"name": "Ascendant Potion of Darkvision", "typeclass": _POTION_TC, "prototype_key": "ascendant_darkvision", "description": "An inky black potion with faint silver swirls that seem to glow in dim light.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "darkvision"}], "duration": 7200, "named_effect_key": "darkvision_buff"}},
    # Invisibility (SKILLED — invisible condition, exploration duration scaling)
    {"name": "Weak Potion of Invisibility", "typeclass": _POTION_TC, "prototype_key": "weak_invisibility", "description": "A crystal-clear potion that refracts light in unsettling ways.", "tracking_token": "PPotWeakInvis", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "condition", "condition": "invisible"}], "duration": 600, "named_effect_key": "invisible"}},
    {"name": "Standard Potion of Invisibility", "typeclass": _POTION_TC, "prototype_key": "standard_invisibility", "description": "A crystal-clear potion that refracts light in unsettling ways.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "invisible"}], "duration": 1800, "named_effect_key": "invisible"}},
    {"name": "Potent Potion of Invisibility", "typeclass": _POTION_TC, "prototype_key": "potent_invisibility", "description": "A crystal-clear potion that refracts light in unsettling ways.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "invisible"}], "duration": 3600, "named_effect_key": "invisible"}},
    {"name": "Ascendant Potion of Invisibility", "typeclass": _POTION_TC, "prototype_key": "ascendant_invisibility", "description": "A crystal-clear potion that refracts light in unsettling ways.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "invisible"}], "duration": 7200, "named_effect_key": "invisible"}},
    # Barkskin (SKILLED — AC bonus, exploration duration scaling)
    {"name": "Weak Potion of Barkskin", "typeclass": _POTION_TC, "prototype_key": "weak_barkskin", "description": "A rough, bark-brown potion that smells of deep forest and resin.", "tracking_token": "PPotWeakBarkskin", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "stat_bonus", "stat": "armor_class", "value": 2}], "duration": 600, "named_effect_key": "barkskin"}},
    {"name": "Standard Potion of Barkskin", "typeclass": _POTION_TC, "prototype_key": "standard_barkskin", "description": "A rough, bark-brown potion that smells of deep forest and resin.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "stat_bonus", "stat": "armor_class", "value": 3}], "duration": 1800, "named_effect_key": "barkskin"}},
    {"name": "Potent Potion of Barkskin", "typeclass": _POTION_TC, "prototype_key": "potent_barkskin", "description": "A rough, bark-brown potion that smells of deep forest and resin.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "stat_bonus", "stat": "armor_class", "value": 4}], "duration": 3600, "named_effect_key": "barkskin"}},
    {"name": "Ascendant Potion of Barkskin", "typeclass": _POTION_TC, "prototype_key": "ascendant_barkskin", "description": "A rough, bark-brown potion that smells of deep forest and resin.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "stat_bonus", "stat": "armor_class", "value": 5}], "duration": 7200, "named_effect_key": "barkskin"}},
    # Feather Fall (SKILLED — negate fall damage, exploration duration scaling)
    {"name": "Weak Potion of Feather Fall", "typeclass": _POTION_TC, "prototype_key": "weak_feather_fall", "description": "A wispy, pale potion that seems almost weightless in the vial.", "tracking_token": "PPotWeakFeathFall", "default_metadata": {"potion_mastery_tier": 2, "potion_effects": [{"type": "condition", "condition": "feather_fall"}], "duration": 600, "named_effect_key": "feather_fall"}},
    {"name": "Standard Potion of Feather Fall", "typeclass": _POTION_TC, "prototype_key": "standard_feather_fall", "description": "A wispy, pale potion that seems almost weightless in the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "feather_fall"}], "duration": 1800, "named_effect_key": "feather_fall"}},
    {"name": "Potent Potion of Feather Fall", "typeclass": _POTION_TC, "prototype_key": "potent_feather_fall", "description": "A wispy, pale potion that seems almost weightless in the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "feather_fall"}], "duration": 3600, "named_effect_key": "feather_fall"}},
    {"name": "Ascendant Potion of Feather Fall", "typeclass": _POTION_TC, "prototype_key": "ascendant_feather_fall", "description": "A wispy, pale potion that seems almost weightless in the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "feather_fall"}], "duration": 7200, "named_effect_key": "feather_fall"}},
    # Haste (EXPERT — extra attack per round, combat duration scaling)
    {"name": "Standard Potion of Haste", "typeclass": _POTION_TC, "prototype_key": "standard_haste", "description": "A crackling amber potion that vibrates faintly in its vial, as if eager to be consumed.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "hasted"}], "duration": 30, "named_effect_key": "hasted"}},
    {"name": "Potent Potion of Haste", "typeclass": _POTION_TC, "prototype_key": "potent_haste", "description": "A crackling amber potion that vibrates faintly in its vial, as if eager to be consumed.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "hasted"}], "duration": 60, "named_effect_key": "hasted"}},
    {"name": "Ascendant Potion of Haste", "typeclass": _POTION_TC, "prototype_key": "ascendant_haste", "description": "A crackling amber potion that vibrates faintly in its vial, as if eager to be consumed.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "hasted"}], "duration": 120, "named_effect_key": "hasted"}},
    # Flight (EXPERT — fly condition, exploration duration scaling)
    {"name": "Standard Potion of Flight", "typeclass": _POTION_TC, "prototype_key": "standard_flight", "description": "A swirling sky-blue potion with wisps of cloud drifting inside the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "fly"}], "duration": 900, "named_effect_key": "fly_buff"}},
    {"name": "Potent Potion of Flight", "typeclass": _POTION_TC, "prototype_key": "potent_flight", "description": "A swirling sky-blue potion with wisps of cloud drifting inside the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "fly"}], "duration": 1800, "named_effect_key": "fly_buff"}},
    {"name": "Ascendant Potion of Flight", "typeclass": _POTION_TC, "prototype_key": "ascendant_flight", "description": "A swirling sky-blue potion with wisps of cloud drifting inside the vial.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "fly"}], "duration": 3600, "named_effect_key": "fly_buff"}},
    # Water Breathing (EXPERT — water_breathing condition, exploration duration scaling)
    {"name": "Standard Potion of Water Breathing", "typeclass": _POTION_TC, "prototype_key": "standard_water_breathing", "description": "A deep teal potion with tiny bubbles that never seem to pop.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "water_breathing"}], "duration": 900, "named_effect_key": "water_breathing_buff"}},
    {"name": "Potent Potion of Water Breathing", "typeclass": _POTION_TC, "prototype_key": "potent_water_breathing", "description": "A deep teal potion with tiny bubbles that never seem to pop.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "water_breathing"}], "duration": 1800, "named_effect_key": "water_breathing_buff"}},
    {"name": "Ascendant Potion of Water Breathing", "typeclass": _POTION_TC, "prototype_key": "ascendant_water_breathing", "description": "A deep teal potion with tiny bubbles that never seem to pop.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "water_breathing"}], "duration": 3600, "named_effect_key": "water_breathing_buff"}},
    # Comprehension (EXPERT — comprehend_languages condition, exploration duration scaling)
    {"name": "Standard Potion of Comprehension", "typeclass": _POTION_TC, "prototype_key": "standard_comprehension", "description": "A swirling rainbow potion that whispers faintly in a dozen tongues.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "condition", "condition": "comprehend_languages"}], "duration": 900, "named_effect_key": "comprehend_languages_buff"}},
    {"name": "Potent Potion of Comprehension", "typeclass": _POTION_TC, "prototype_key": "potent_comprehension", "description": "A swirling rainbow potion that whispers faintly in a dozen tongues.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "condition", "condition": "comprehend_languages"}], "duration": 1800, "named_effect_key": "comprehend_languages_buff"}},
    {"name": "Ascendant Potion of Comprehension", "typeclass": _POTION_TC, "prototype_key": "ascendant_comprehension", "description": "A swirling rainbow potion that whispers faintly in a dozen tongues.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "condition", "condition": "comprehend_languages"}], "duration": 3600, "named_effect_key": "comprehend_languages_buff"}},
    # Stoneskin (EXPERT — physical damage resistance, combat duration + value scaling)
    {"name": "Standard Potion of Stoneskin", "typeclass": _POTION_TC, "prototype_key": "standard_stoneskin", "description": "A granite-grey potion flecked with mineral dust that crunches faintly when shaken.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 3, "potion_effects": [{"type": "damage_resistance", "damage_type": "bludgeoning", "value": 20}, {"type": "damage_resistance", "damage_type": "slashing", "value": 20}, {"type": "damage_resistance", "damage_type": "piercing", "value": 20}], "duration": 60, "named_effect_key": "stoneskin"}},
    {"name": "Potent Potion of Stoneskin", "typeclass": _POTION_TC, "prototype_key": "potent_stoneskin", "description": "A granite-grey potion flecked with mineral dust that crunches faintly when shaken.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 4, "potion_effects": [{"type": "damage_resistance", "damage_type": "bludgeoning", "value": 35}, {"type": "damage_resistance", "damage_type": "slashing", "value": 35}, {"type": "damage_resistance", "damage_type": "piercing", "value": 35}], "duration": 90, "named_effect_key": "stoneskin"}},
    {"name": "Ascendant Potion of Stoneskin", "typeclass": _POTION_TC, "prototype_key": "ascendant_stoneskin", "description": "A granite-grey potion flecked with mineral dust that crunches faintly when shaken.", "tracking_token": None, "default_metadata": {"potion_mastery_tier": 5, "potion_effects": [{"type": "damage_resistance", "damage_type": "bludgeoning", "value": 50}, {"type": "damage_resistance", "damage_type": "slashing", "value": 50}, {"type": "damage_resistance", "damage_type": "piercing", "value": 50}], "duration": 120, "named_effect_key": "stoneskin"}},
    # ── Jewellery ──
    ...
    # Skilled alchemy recipe scrolls
    {"name": "Potion of Detection Recipe", "typeclass": _RECIPE_TC, "prototype_key": "detection_recipe", "description": "A scroll describing how to brew a potion that reveals the invisible, using moonpetal essence, mindcap, and ogre's cap."},
    {"name": "Potion of Darkvision Recipe", "typeclass": _RECIPE_TC, "prototype_key": "darkvision_recipe", "description": "A scroll describing how to brew a potion of darkvision from moonpetal essence, sage leaf, and mindcap."},
    {"name": "Potion of Invisibility Recipe", "typeclass": _RECIPE_TC, "prototype_key": "invisibility_recipe", "description": "A scroll describing how to brew a potion of invisibility from moonpetal essence, arcane dust, and siren petal."},
    {"name": "Potion of Barkskin Recipe", "typeclass": _RECIPE_TC, "prototype_key": "barkskin_recipe", "description": "A scroll describing how to brew an armour-hardening potion from moonpetal essence, ironbark, and vipervine."},
    {"name": "Potion of Feather Fall Recipe", "typeclass": _RECIPE_TC, "prototype_key": "feather_fall_recipe", "description": "A scroll describing how to brew a potion that negates fall damage, using moonpetal essence, windroot, and bloodmoss."},
    # Expert alchemy recipe scrolls
    {"name": "Potion of Haste Recipe", "typeclass": _RECIPE_TC, "prototype_key": "haste_recipe", "description": "A scroll describing how to brew a potion of haste from starbloom nectar, moonpetal essence, and vipervine."},
    {"name": "Potion of Flight Recipe", "typeclass": _RECIPE_TC, "prototype_key": "flight_recipe", "description": "A scroll describing how to brew a potion of flight from starbloom nectar, moonpetal essence, and windroot."},
    {"name": "Potion of Water Breathing Recipe", "typeclass": _RECIPE_TC, "prototype_key": "water_breathing_recipe", "description": "A scroll describing how to brew a potion of water breathing from starbloom nectar, moonpetal essence, and bloodmoss."},
    {"name": "Potion of Comprehension Recipe", "typeclass": _RECIPE_TC, "prototype_key": "comprehension_recipe", "description": "A scroll describing how to brew a potion of comprehension from starbloom nectar, moonpetal essence, and mindcap."},
    {"name": "Potion of Stoneskin Recipe", "typeclass": _RECIPE_TC, "prototype_key": "stoneskin_recipe", "description": "A scroll describing how to brew a potion of stoneskin from starbloom nectar, moonpetal essence, ogre's cap, and ironbark."},
