"""
Hundred Acre Wood — book zone (DEPRECATED).

============================================================
DEPRECATION NOTICE — 2026-05-17

World deployment for this zone happens exclusively through
the evennia-world-builder library (`wb_build`) reading from
    fcm-world/shard0/millholm/winnie-the-pooh/hundred-acre-wood.yaml
Mob populations are deployed via evennia-mob-spawner with
    ms_load shard=shard0 zone=hundred-acre-wood

The entire previous content of this module — build_hundred_acre_wood,
clean_hundred_acre_wood, soft_deploy, the ZONE/DISTRICT
constants and every import — is believed to be non-active
code and has been commented out below pending live testing
and confirmation. Marked for future deletion.
============================================================
"""

# Imports below used only by the commented-out build_hundred_acre_wood
# function. Believed non-active, pending live testing and confirmation;
...
#     # SUSPECTED DEAD — pending confirmation before deletion.
#     # World content for this zone is now built via wb_build from
#     # fcm-world/shard0/millholm/winnie-the-pooh/hundred-acre-wood.yaml.
