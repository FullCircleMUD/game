...
def get_height_hit_modifier(attacker, target, weapon):
    ...
    Ranged weapons (wielded or innate) at the same height as the target
    ...
    if weapon and getattr(weapon, "weapon_type", "melee") == "ranged":
        is_ranged = True
    elif getattr(attacker, "mob_weapon_type", None) == "ranged":
        is_ranged = True
